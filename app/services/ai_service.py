...
# Ensure you have your other imports (AiServiceError, etc.) at the top of your file
    async def chat_with_transcript(
        ...
        system_instruction = (
            ...
            "- New Meeting (/new-meeting): Users upload a meeting transcript file (supports .txt, .pdf, .doc, or .docx up to 20MB) "
            "and click 'Generate Insights'. (Note: The app does not support audio files or pasting raw text). The AI then extracts an "
            "executive summary and action items prioritized by the Eisenhower Matrix (Urgent & Important, Important but Not Urgent, Urgent but Not Important, Low Priority).\n"
            ...
            "- If the user asks a purely educational question about how to use the app itself (e.g. 'how do I start a new meeting', 'how do I export a PDF'), answer with navigation and feature instructions based strictly on the Application Knowledge section.\n"
