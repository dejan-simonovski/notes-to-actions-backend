...
# Ensure you have your other imports (AiServiceError, etc.) at the top of your file
    async def chat_with_transcript(
        ...
        system_instruction = (
            ...
            "- New Meeting (/new-meeting): Users upload a Google Doc file containing their meeting transcript, then click "
            "'Generate Insights'. (Note: The app does not support audio files or pasting raw text). The AI then extracts an "
